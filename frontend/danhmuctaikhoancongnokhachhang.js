...
$(document).ready(function () {
    ...
    function load_data() {
        $.ajax({
            method: "GET",
            dataType: "json",
            url: "http://localhost:3000/danhmuctaikhoancongnokhachhang",
            success: function (data){
                ...
                $('#danhmuctaikhoancongnokhachhang tbody').html(html);
                //console.log(html)
            }
        });
    };
    ...
    $(document).on('click', '.delete', function(){
        ...
        {
            $.ajax({
                url:"http://localhost:3000/danhmuctaikhoancongnokhachhang/deletetaikhoancongno/"+cMaKhachHang,
                method:"DELETE",
                success:function()
                {
