...
$(document).ready(function () {
    ...
    function load_data() {
        $.ajax({
            method: "GET",
            dataType: "json",
            url: "http://localhost:3000/phieuthuchitiet",
    ...
    $(document).on('click', '.delete', function(){
        ...
        {
            $.ajax({
                url:"http://localhost:3000/phieuthuchitiet/deletephieuthu/"+cMaChungTu,
                method:"DELETE",
                success:function()
                {
